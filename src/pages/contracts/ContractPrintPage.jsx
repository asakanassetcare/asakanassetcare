    ...
    <div className="min-h-screen bg-slate-100 py-6 print:bg-white print:py-0">
      ...
      <main className="print-page mx-auto w-[210mm] bg-white px-[14mm] py-[13mm] shadow-xl ring-1 ring-slate-200 print:ring-0">
        ...
        <Sec title="ข้อ 3. ค่าเช่าและการชำระค่าเช่า">
          ...
          <p>3.3 หากผู้เช่าผิดนัดชำระค่าเช่าหรือค่าใช้จ่ายอื่นใดตามสัญญานี้ ผู้เช่ายินยอมชำระดอกเบี้ยในอัตราร้อยละ 15 ต่อปี ของจำนวนเงินที่ค้างชำระ นับแต่วันที่ผิดนัดจนถึงวันที่ชำระเสร็จสิ้น</p>
        </Sec>
        ...
        <Sec title="ข้อ 11. การส่งมอบห้องชุดที่เช่าคืน">
          ...
          <p>11.3 หากผู้เช่าไม่ส่งมอบห้องชุดที่เช่าคืนภายในกำหนด ผู้เช่ายินยอมชำระค่าเสียหายเป็นรายวัน ในอัตราวันละ 2 เท่าของค่าเช่ารายวัน นับแต่วันที่ครบกำหนดส่งมอบ จนถึงวันที่ส่งมอบจริง</p>
        </Sec>
